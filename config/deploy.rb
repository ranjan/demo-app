...
set :application, "tenantscoop"
set :repo_url, "git@github.com:jrslyrics/TenantScoop.git"

set :app_server, "tenantscoop.com"
set :user, 'deploy'
set :rvm_ruby_version, '2.7.2'
#server 'mysite.com', port: 22, roles: [:web, :app, :db], primary: true
server "#{fetch(:app_server)}", roles: %w{app db web}, primary: true
